...
class MyTestCase(unittest.TestCase):
    ...
    def test_circle_area(self):
        circle = Circle(8)
        assert isclose(circle.area(),201.06192, abs_tol=1e-3) == True, print("Passed")

    def test_circle_circumference(self):
        circle = Circle(8)
        assert isclose(circle.circumference(),50.26548, abs_tol=1e-3) == True, print("Passed")
    ...
    def test_PI(self):
        assert isclose(PI(),3.14159265358979,abs_tol=1e-5) == True
